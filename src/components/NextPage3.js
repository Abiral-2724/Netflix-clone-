    ...
    <div>
      <div className="nextpage1-wrapper">
        ...
        <div className="nextpage1-part2">
          <div className="nextpage3-container">
            <p className="nextpage3-step2">STEP 2 OF 3</p>
            <h3 className="Choose-your-plan">Choose your plan.</h3>
            <ul className="list-nextpage3">
              <li className="listtag-nextpage3">
            ...
            <button className="nextbutton" onClick={changehandler}>
              Next
            </button>
          </div>
        </div>
