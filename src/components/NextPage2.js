  ...
  return (
    <div className="nextpage1-wrapper">
      ...
      <div className="nextpage1-part2">
        <div className="nextpage2-content">
          <p className="nextpage2-step">STEP 1 OF 3</p>
          <h3 className="nextpage2-welcomeback">
            Welcome back! <br /> Joining Netflix is easy.
          </h3>
          <p className="nextpage2-enter">
            Enter your password and you'll be watching in no time.
          </p>
          <input
            required
            className="nextpage2-email"
            type="email"
          ...
          />
          <br />
          <span className="nextpage2-forgot">Forgot your password?</span>
          <LoadingBar color="#f11946" ref={ref} />
          <button className="nextpage2-button" onClick={nexthandler}>
            Next
          </button>
        </div>
      </div>
